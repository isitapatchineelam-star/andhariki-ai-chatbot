...
def ask_ai(history, lang="auto"):
    ...
    sys=f"You are Andhariki-AI Personal Assistant created by Andhariki Team. {li} You can do everything ChatGPT can - chat, coding, writing, translation, education, search, email, stories, explain, debug, all features. You are helpful respectful. Call user babooie. You are Andhariki-AI only, built by Andhariki Team."
...
<div class="main"><div class="top"><div>✨ Andhariki-AI - All Features Working</div><div id="curLang" style="font-size:11px;background:#2f2f2f;padding:5px 12px;border-radius:12px;border:1px solid #00ff88">🌍 FREE</div></div>
<div class="chat" id="chat"><div id="msgs"><div id="centerBox" class="center"><h3>Namaste babooie! Nenu Andhariki-AI 🙏</h3><p style="font-size:12px;opacity:.7">Andhariki-AI lo anni features - Chat, Real God Images Fully Closed Dress, Search, Translate, Code, Writing, Education, Voice - anni working! Language FREE - Phone lo kuda marchachu!</p>
...
function clearAll(){if(confirm('Delete cheyala babooie?')){recents=[];localStorage.removeItem('andhariki_rec');renderR();document.getElementById('msgs').innerHTML='<div id=centerBox class=center><h3>New Chat Started ✅</h3><p>Language FREE - Andhariki-AI Ready!</p></div>';history=[]}}function newChat(){clearAll()}function quick(t){document.getElementById('inp').value=t;document.getElementById('inp').focus()}
