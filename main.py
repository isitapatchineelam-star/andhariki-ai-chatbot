...
# FIXED - CHEST 100% CLOSED - BUTTONED KURTA
GODS = {
"rama": "Lord Rama traditional Raja Ravi Varma oil painting ancient temple mural age 26 wearing FULLY CLOSED golden silk achkan kurta buttoned up to neck high collar long sleeves thick fabric chest 100 percent covered no skin visible no chest visible orange silk dhoti golden mukut pearl haram holding bow Ayodhya realistic temple style modest divine",
"krishna": "Lord Krishna traditional Raja Ravi Varma painting blue skin wearing FULLY CLOSED golden embroidered achkan kurta buttoned up to neck high collar long sleeves thick fabric chest 100 percent covered no skin visible no bare chest yellow dhoti orange angavastram peacock feather mukut playing flute realistic temple mural modest divine",
"shiva": "Lord Shiva traditional temple painting wearing FULLY CLOSED saffron kurta tiger skin rudraksha mala chest covered thick fabric no bare chest trishul damru realistic NOT topless divine",
"ganesh": "Lord Ganesha traditional Raja Ravi Varma painting elephant head wearing FULLY CLOSED red golden kurta dhoti chest covered thick fabric golden crown modak realistic divine",
"hanuman": "Lord Hanuman traditional mural wearing FULLY CLOSED orange kurta dhoti buttoned chest 100 percent covered no bare chest golden crown gada realistic NOT topless",
"durga": "Goddess Durga traditional temple painting Raja Ravi Varma wearing FULLY CLOSED red silk saree with fully closed blouse chest 100 percent covered no cleavage golden crown lion weapons realistic modest respectful",
"lakshmi": "Goddess Lakshmi traditional painting wearing FULLY CLOSED red saree blouse chest fully covered thick fabric modest temple style",
"saraswati": "Goddess Saraswati traditional painting wearing FULLY CLOSED white saree blouse chest fully covered veena",
"venkateswara": "Lord Venkateswara Balaji traditional Tirupati painting wearing FULLY CLOSED golden silk dhoti kurta buttoned chest 100 percent covered no skin crown tilak realistic",
"ayyappa": "Lord Ayyappa traditional Kerala mural wearing FULLY CLOSED black kurta dhoti buttoned chest fully covered no bare chest",
"saibaba": "Shirdi Sai Baba traditional painting wearing FULLY CLOSED white kafni long kurta buttoned chest fully covered no skin"
}
...
def get_prompt(q):
    ...
    return f"{clean} traditional Raja Ravi Varma oil painting ancient Indian temple mural ultra realistic wearing FULLY CLOSED kurta buttoned up to neck chest 100 percent covered thick fabric no skin visible no bare chest no topless no open chest modest divine respectful 4k"

def ask_ai(history, lang="auto"):
    lang_i = f"Reply ONLY in {lang}. " if lang!="auto" else "Auto detect same language. "
    sys = f"You are Andhariki-AI Personal Assistant by Andhariki Team. {lang_i} You work exactly like ChatGPT - chat, coding, writing, translation, education, search summary, email, stories, explain, debug everything. Be helpful. Call user babooie. Never say ChatGPT/OpenAI. You are Andhariki-AI only."
...
<div class="item" onclick="quick('create image lord rama traditional temple painting')">🖼️ Create Image - Traditional Full Closed Dress</div><div class="item" onclick="quickSearch()">🌐 Search the Web</div><div class="item" onclick="quick('Write a love story in Telugu')">✏️ Writing / Email / Essay</div><div class="item" onclick="quick('Translate to English: Nenu bagunna')">🌍 Translate</div><div class="item" onclick="quick('Python code for calculator with explanation')">💻 Code - Like ChatGPT</div><div class="item" onclick="quick('Explain AI in simple Telugu')">📚 Education</div>
...
<div class="main"><div class="top"><div>✨ Andhariki-AI - All ChatGPT Features Working</div><div id="curLang" style="font-size:11px;background:#2f2f2f;padding:5px 12px;border-radius:12px">🌍 Auto</div></div>
<div class="chat" id="chat"><div id="msgs"><div id="centerBox" class="center"><h3>Namaste babooie! Nenu Andhariki-AI 🙏</h3><p style="font-size:12px;opacity:.6">ChatGPT la anni features - Traditional Gods 100% Full Closed Dress lo - Chest Open Undadu!</p>
<div class="opt" onclick="quick('create image lord rama traditional temple painting raja ravi varma style')">🙏 Rama - Full Closed Kurta</div><div class="opt" onclick="quick('create image lord krishna traditional temple painting')">🦚 Krishna - Full Closed Kurta</div><div class="opt" onclick="quick('create image lord shiva traditional')">🔱 Shiva - Full Closed</div><div class="opt" onclick="quick('Write python code for student marks')">💻 Code Like ChatGPT</div></div></div></div>
<div style="padding:14px"><div class="box"><button class="icon" onclick="quick('create image ')">+</button><input id="inp" placeholder="Emaina adugu babooie..." onkeypress="if(event.key==='Enter')send()"><button class="icon" onclick="startVoice()">🎤</button><button class="send" onclick="send()">↑</button></div><div style="text-align:center;font-size:10px;opacity:.25;margin-top:6px">Andhariki-AI - All Features Working - Traditional 100% Closed Dress</div></div></div><button class="newchat" onclick="newChat()">📝 New Chat</button>
<script>
...
function clearAll(){if(confirm('Delete cheyala babooie?')){recents=[];localStorage.removeItem('andhariki_rec');renderR();document.getElementById('msgs').innerHTML='<div id=centerBox class=center><h3>New Chat Started ✅</h3><p>Andhariki-AI Ready!</p></div>';history=[]}}function newChat(){clearAll()}function quick(t){document.getElementById('inp').value=t;document.getElementById('inp').focus()}
